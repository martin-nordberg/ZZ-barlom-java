...
/**
 * Service for querying Barlom directed edge types.
 */
...
public class DirectedEdgeTypeQueries {
    ...
    @GET
    @Path( "" )
    @Produces( { "application/json", "application/vnd.barlom.org.v1.directededgetype+json" } )
    public String getAllDirectedEdgeTypes() {
        ...
        json.writeStartArray( "directedEdgeTypes" );
