...
import org.grestler.restserver.services.Stuff;
...
public class StuffMapper
    ...
    public boolean isWriteable( Class<?> clazz, Type type, Annotation[] annotations, MediaType mediaType ) {
        ...
        boolean result = "org.grestler.restserver.services".equals( clazz.getPackage().getName() );
        result = result && mediaType.getType().equals( "application" );
        result = result && mediaType.getSubtype().matches( "(vnd\\.grestler\\.org\\.v1\\..*\\+)?json" );
        return result;
