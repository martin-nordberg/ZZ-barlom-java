...
-- Primary key
ALTER TABLE GRESTLER_DIRECTED_EDGE_TYPE ADD CONSTRAINT PK_GRESTLER_DIRECTED_EDGE_TYPE
    PRIMARY KEY (ID);
...
-- Primary key
ALTER TABLE GRESTLER_UNDIRECTED_EDGE_TYPE ADD CONSTRAINT PK_GRESTLER_UNDIRECTED_EDGE_TYPE
    PRIMARY KEY (ID);
